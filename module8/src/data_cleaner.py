...
def main():
    ...
    background_file = os.path.join(data_dir, 'backgrounds', 'background_2.wav')
    ...
    # ==========================================================================
    dataset = load_dataset(os.path.join(data_dir, f'{fr}.npy'), dataset)
    x_train, y_train, x_test, y_test = dataset
    # ==========================================================================
    # Writing Numpy array to WAV file (Testing)
    # ==========================================================================
    x_train = np.reshape(x_train, (-1, frame_rate, x_train.shape[-1] // frame_rate))
    print('x_train.shape', x_train.shape)
    x = os.path.join(data_dir, 'x.wav')
    y = os.path.join(data_dir, 'y.wav')
    print('x_train[5].shape: ', x_train[5].shape)
    numpy2wav(x_train[5], x)
    numpy2wav(y_train[5], y)
