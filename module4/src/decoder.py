...
def decoder(dictionary, word_counter, bigram_counter):
    MAX_LEN = 16
    BEAM_LEN = 3
    sentence = [['EOS'] * MAX_LEN] * 3
    p = {}
    for word in dictionary:
        p_e = language_model([word], word_counter, bigram_counter)
...
'''
    ...
    dictionary = list(word_counter)
    dictionary.append('EOS')
    print(dictionary)

    decoder(dictionary, word_counter, bigram_counter)
